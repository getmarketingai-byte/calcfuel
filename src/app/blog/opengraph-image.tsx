...
export const alt = "CalcFuel fuel and running cost guides";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ fontSize: 29, color: "#3F4A5A", maxWidth: 900, lineHeight: 1.35 }}>
            What it actually costs to run a vehicle in Australia — petrol cycles, diesel vs petrol, hybrid and EV break-even points.
          </div>
        </div>
