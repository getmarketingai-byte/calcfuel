...
export const alt = "Australian fuel price data by capital city";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ fontSize: 29, color: "#3F4A5A", maxWidth: 900, lineHeight: 1.35 }}>
            Capital city unleaded and diesel averages, within-city spread and the 2026 excise timeline, from the ACCC weekly report.
          </div>
        </div>
